...
function plugin_include($victro_file){
	echo '<script src="'.THEME.'plugins/'.$victro_file.'"></script>';
}
function plugincss_include($victro_file){
	echo '<link href="'.THEME.'plugins/'.$victro_file.'" rel="stylesheet" />';
}
function load_plugin($victro_file){
	echo '$.getScript("'.THEME.'plugins/'.$victro_file.'", function() {});';
}
function basic_css(){
	...
	echo '<link rel="stylesheet" href="'.THEME.'plugins/DataTable/datatables.min.css">';
	...
	echo '<link href="'.SITE_URL.'victro_js/sys.css" rel="stylesheet" />';
	echo '<link href="'.SITE_URL.'victro_js/dropzone.css" rel="stylesheet" />';
}
function basic_js(){
...
function basic_js2(){
	...
	echo '<script src="'.THEME.'plugins/DataTable/datatables.min.js"></script>';
	echo '<script src="'.THEME.'dist/js/pages/dashboard2.js"></script>';
	//echo '<script src="'.THEME.'dist/js/demo.js"></script>';
	echo '<script src="'.SITE_URL.'victro_js/notification.js"></script>';
	echo '<script src="'.SITE_URL.'victro_js/dropzone.js"></script>';
	echo '<script src="'.SITE_URL.'victro_js/sys.js"></script>';
	echo '<script src="'.SITE_URL.'victro_js/search.js"></script>
