                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <div class="panel-title">
                                ...
                                <h4>Install - SendMail Settings</h4>
				<div class="progress">
                        ...
                        <div class="panel-body">
                            <form class="form form-vertical" method="post">
                                <div class="control-group">
                                    <label>Name:</label>
                                    <div class="controls">
                                        <input type="text" required class="form-control" name="name" placeholder="Write your email name">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label>E-mail:</label>
                                ...
                                <div class="control-group">
                                    <label>SMTP url:</label>
                                    <div class="controls">
                                        <input type="text" required class="form-control" name="smtp" placeholder="SMTP url">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label>SMTP port:</label>
                                    <div class="controls">
                                        <input type="text" required class="form-control" name="port" placeholder="SMTP port">
                                    </div>
                                </div>
